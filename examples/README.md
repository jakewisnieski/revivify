...
| [`accidental-noindex/`](accidental-noindex/) | A leftover `noindex` hiding the page from Google — flagged as **"Your call"**, not auto-fixed, because it can be deliberate | **9 / 10 · Not yet ⚠️** |
